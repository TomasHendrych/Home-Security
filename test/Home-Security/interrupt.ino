...
////////////////////////////////////////////////////////////////////////////
  ...
  attachInterrupt(digitalPinToInterrupt(pir), pressInterrupt, FALLING);
///////////////////////////////////////////////////////////////////////////
...
void pressInterrupt() { // ISR
  ...
  for (int i = 0; i < sizeof(pir) / sizeof(int); i++) { // Test each button for press
    if (!digitalRead(pir)) {
      press(i);
    }
  }
...
void configureCommon() {
  ...
  for (int i = 0; i < sizeof(pir) / sizeof(int); i++) {
    pinMode(pir, INPUT);
